  ...
  return (
    <div className="h-[85vh] flex items-start justify-center sticky top-24 md:top-32">
      <motion.a
        ...
        className="absolute top-[var(--card-offset)] flex h-[500px] w-full max-w-[1760px] flex-col items-center justify-center gap-6 overflow-hidden rounded-[40px] border-2 border-[#D7E2EA] bg-[#0C0C0C] p-8 text-center origin-top transition-colors duration-300 hover:bg-[#151515] sm:h-[calc(85vh-3rem)] sm:rounded-[50px] md:h-[660px] md:rounded-[60px]"
      >
